  ...
  return (
    <div className={'mt-4 flex flex-col space-y-24 py-14'}>
      <Hero
        ...
        title={<span>Stop wasting time reading long PDFs</span>}
        subtitle={
          <span>
            Upload your PDFs and let us help you understand them. Our AI is
            capable of answering your questions about your PDFs. Get started for
            free.
          </span>
        }
